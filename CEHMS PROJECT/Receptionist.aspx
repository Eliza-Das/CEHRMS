<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Receptionist.aspx.cs" Inherits="CEHMS_PROJECT.Receptionist" %>
                ...
                <div class="sidebar">
                    <nav class="navbar">
                        ...
                        <div class="navbar-nav w-100">
                            <a href="Receptionist.aspx" class="nav-item nav-link ac tive"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
<%--                            <a href="BookAppointment.aspx" class="nav-item nav-link ac tive"><i class="fa fa-tachometer-alt me-2"></i>Book Appointment</a>--%>
                                                        <a href="Patient Registration.aspx" class="nav-item nav-link ac tive"><i class="fa fa-tachometer-alt me-2"></i>Patient Registration</a>
