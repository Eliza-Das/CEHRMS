<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientHistory.aspx.cs" Inherits="CEHMS_PROJECT.PatientHistory" %>
                ...
                <div class="sidebar">
                    <nav class="navbar">
                        ...
                        <div class="navbar-nav w-100">
                            <a href="AdminDashboard.aspx" class="nav-item nav-link ac tive"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-4">
                    ...
                    <div class="d-flex align-items-right align-items-end dropdown" style="">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="assetsdash/img/UserAvtar.png" alt="" style="width: 40px; height: 40px; margin-left: 800px" />
                                ...
                                <div class="card-body p-md-5 mx-md-4">
                                    <div class="container-fluid pt-5 px-5">
                                        <form id="form1" class="form-inline login-content" runat="server">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <asp:TextBox ID="txtPatId" CssClass="form-control" runat="server" placeholder="Patient ID"></asp:TextBox>
                                                </div>
                                                <div class="col-md-3">
                                                    <asp:Button ID="btnSearch" runat="server" Text="Search" class="btn btn-info" OnClick="btnSearch_Click" />
                                                </div>
                                                <div class="col-md-3">
                                                    <asp:Button ID="btnClrSearch" runat="server" Text="Clear Filter" class="btn btn-info" OnClick="btnClrSearch_Click"/>
                                                </div>
                                            </div>
                                            <br />
                                            <br />
                                            ...
                                            <div class="row">
                                                ...
                                                <br />
                                                <div class="col-lg-12">
                                                    <asp:GridView ID="gridUser" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered" style="width: 800px" HeaderStyle-BackColor="#067727" BackColor="#ecf0f1" HeaderStyle-ForeColor="#ffffff" AllowPaging="true" PageSize="2" OnPageIndexChanging="gridUser_PageIndexChanging">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="DoctorID">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDocId" runat="server" Text='<%# Eval("DoctorID") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="PatientID">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblPatId" runat="server" Text='<%# Eval("PatientId") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Date">
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblDOV" runat="server" Text='<%# Eval("DateOfVisit", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                            <asp:TemplateField HeaderText="Prescription">
                                                                <ItemTemplate>
                                                                    <a href="Prescription.aspx">View Prescription</a>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                    </asp:GridView>
