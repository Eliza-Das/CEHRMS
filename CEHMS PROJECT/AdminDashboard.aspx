<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminDashboard.aspx.cs" Inherits="CEHMS_PROJECT.AdminDashboard" %>
        ...
        <div class="row ">
                ...
                <div class="sidebar">
                    <nav class="navbar">
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <a href="REV_FEEDBACK.aspx" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Feedback</a>
                        </div>
                    </nav>
                </div>
            </div>
            ...
            <div class="content">
                ...
                <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-4">
                    ...
                    <div class="d-flex align-items-right align-items-end dropdown" style="">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex"><br />
                                <br />
                ...
                <div class="container-fluid pt-5 px-5">
                    <div class="row g-4">
                        <div class="backimg">
                            <img src="assets1/img/LogoNewTransparent.png" style="height: 500px" />
                        </div>
                        <div class="col-sm-4 ">
