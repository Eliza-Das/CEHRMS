<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ADM_GREVIANCE.aspx.cs" Inherits="CEHMS_PROJECT.ADM_GREVIANCE" %>
...
<body>
    <div class="container-xxl position-relative bg-white ">
     ...
     <h4 class="text-success">EmployeeId:
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="PATIENT_ID">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="FEEDBACK">
                <ItemTemplate>
                    <asp:Label ID="lblFedb" runat="server" Text='<%# Eval("Feedback") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="RESOLVED OR NOT">
                <ItemTemplate>
                    <asp:Label ID="lblRev" runat="server" Text='<%# Eval("ReviewComment") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            
            <%--<asp:TemplateField HeaderText="Reply">
                <ItemTemplate>
                    <asp:Label ID="lblRep" runat="server" Text='<%# Eval("Reply") %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>--%>
    ...
    <div class="row">
    <div class="col-md-4">
    <asp:TextBox ID="txtRep" runat="server" Visible="false" TextMode="MultiLine" CssClass="form-control" placeholder="Reply"></asp:TextBox>
         </div>
